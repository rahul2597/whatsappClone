...
const Nav = (props) => {
  return (
    <>
      <div className=" bg-slate-200 flex items-center w-full h-auto pl-4">
        <div className="flex items-center p-4 w-2/3">
          <img
            ...
            alt=""
          />
          <h4 className="text-black font-bold text-2xl ml-2">{props.name}</h4>
        </div>
        <div className="flex justify-end p-4 items-center w-1/3">
          <button className="pl-4">{props.icon1}</button>
          <button className="pl-4" onClick={props.showForm}>
            {props.icon2}
          </button>
